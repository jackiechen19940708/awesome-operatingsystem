# system call
1. use api declaration
```
int exec(const char*, char**);
```
2. api implement using assemble languate, call ecall 
```
.global exec
exec:
 li a7, SYS_exec
...
usertrap(void)
{
  ...
  // important, here go into the syscall
  if(r_scause() == 8){
    // system call
...
4. syscall
syscall pick the syscall function (predefined in the syscalls fun array) according to the a7 register.
```
...
6. usertrapret
the usertrap will finally call usertrapret to return 
```
//
// return to user space
//
